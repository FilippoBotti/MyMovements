    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoRouteTable.equals(_existingRouteTable)) {
          return new RoomOpenHelper.ValidationResult(false, "route_table(com.mobdev.hellotabs.model.Route).\n"
                  + " Expected:\n" + _infoRouteTable + "\n"
                  + " Found:\n" + _existingRouteTable);
        }
        ...
        if (! _infoPoiTable.equals(_existingPoiTable)) {
          return new RoomOpenHelper.ValidationResult(false, "poi_table(com.mobdev.hellotabs.model.PointOfInterest).\n"
                  + " Expected:\n" + _infoPoiTable + "\n"
                  + " Found:\n" + _existingPoiTable);
        }
